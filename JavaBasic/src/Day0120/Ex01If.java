...
// 코드 블락 안에는 다른 코드 블락이 들어올 수 올수도 있다.
// 코드 블락은 제어문의 실행 여부 반복 여부에 따라 실행될 코드가 있냐 없냐로
// 결정이 되기 때문이다.
...
// if 문
// if 문이란 tru/false 가 나오는 조건식이 있고
...
public class Ex01If {
    public static void main(String[] args) {
        ...
        // -> 코드 한줄밖에 안쓰더라도 반드시 명확하게 중괄호를 해줘야 한다.
        
        // -> 유효범위 끝났으니 새로운 name 만들어도 됨.
        String name = "김철수";
